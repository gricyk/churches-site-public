  ...
  try {
    await navigator.modelContext.provideContext({
      tools: [
        {
          name: "find_church",
          description: "Найти русскоязычную или украиноязычную евангельскую церковь (ЕХБ) или баптистскую церковь в любой стране мира по названию страны или города. Каталог содержит 445 церквей в 38 странах на 5 континентах.",
          inputSchema: {
            type: "object",
            properties: {
              country: {
        ...
        },
        {
          ...
          description: "Получить полную базу данных всех церквей каталога в структурированном текстовом формате, оптимизированном для AI-систем. Содержит адреса, расписание, контакты по всем 445 церквям.",
          inputSchema: {
            type: "object",
            properties: {},
            required: []
