  ...
  try {
    await navigator.modelContext.provideContext({
      tools: [
        {
          name: "find_church",
          description: "Найти русскоязычную или украиноязычную евангельскую церковь (ЕХБ) или баптистскую церковь в любой стране мира по названию страны или города. Каталог содержит 428 церквей в 35 странах на 4 континентах.",
          inputSchema: {
            type: "object",
            properties: {
              country: {
        ...
        },
        {
          ...
          description: "Получить полную базу данных всех церквей каталога в структурированном текстовом формате, оптимизированном для AI-систем. Содержит адреса, расписание, контакты по всем 428 церквям.",
          inputSchema: {
            type: "object",
            properties: {},
            required: []
